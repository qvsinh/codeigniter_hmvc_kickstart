...
<head>
  ...
  <body>
    ...
    <?php $this->template->include_view($view['module_view']);?>
    
    <!-- Bootstrap core JavaScript
    ================================================== -->
    <!-- Placed at the end of the document so the pages load faster -->
    <script src="<?php echo $view['global_var']['js_url']; ?>jquery-1.10.1.min.js"></script>
    <script src="<?php echo $view['global_var']['js_url']; ?>jquery-migrate-1.2.1.min.js"></script>
    <script src="<?php echo $view['global_var']['js_url']; ?>bootstrap.min.js"></script>
    <?php
