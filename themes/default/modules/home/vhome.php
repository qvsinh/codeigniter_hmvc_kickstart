...
<nav class="navbar navbar-default navbar-custom" role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <h4>Codeigniter HMVC Kickstart</h4>
    </div>
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        <li><a class="nav-link current" href="#">Link test</a></li>
        <li><a class="nav-link" href="#">Link test 2</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="row">
  <div class="col-md-6">
    <div class="jumbotron">
      <div class="jumbotron-photo"><img src="themes/bootstrap/assets/img/Jumbotron.jpg" /></div>
    ...
    <div class="jumbotron">
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item active"><img src="themes/bootstrap/assets/img/slider1.jpg"></div>
          <div class="item"><img src="themes/bootstrap/assets/img/slider2.jpg"></div>
          <div class="item"><img src="themes/bootstrap/assets/img/slider3.jpg"></div>
        </div>
...
<div class="row">
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img class="themes/bootstrap/assets/img-rounded" src="themes/bootstrap/assets/img/thumbnail-1.jpg" >
  ...
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img class="themes/bootstrap/assets/img-rounded" src="themes/bootstrap/assets/img/thumbnail-2.jpg">
      <div class="caption text-center">
        <h3>Thumbnail label</h3>
        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id ...</p>
        <p><a href="#" class="btn btn-warning" role="button">Button</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
  ...
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img class="themes/bootstrap/assets/img-rounded" src="themes/bootstrap/assets/img/thumbnail-3.jpg">
      <div class="caption text-center">
        <h3>Thumbnail label</h3>
        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id ...</p>
        <p><a href="#" class="btn btn-warning" role="button">Button</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
  ...
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img class="themes/bootstrap/assets/img-rounded" src="themes/bootstrap/assets/img/thumbnail-4.jpg">
      <div class="caption text-center">
        <h3>Thumbnail label</h3>
        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id ...</p>
        <p><a href="#" class="btn btn-warning" role="button">Button</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
...
<div class="row">
  <div class="col-md-12">
    ...
    <ul class="media-list">
      <li class="media">
        <a class="pull-left" href="#"><img class="media-object img-rounded" src="themes/bootstrap/assets/img/photo-1.jpg"></a>
        <div class="media-body">
          ...
          <!-- Nested media object -->
          <div class="media">
            <a class="pull-left" href="#"><img class="media-object img-rounded" src="themes/bootstrap/assets/img/photo-2.jpg"></a>
            <div class="media-body">
              ...
              <!-- Nested media object -->
              <div class="media">
                <a class="pull-left" href="#"><img class="media-object img-rounded" src="themes/bootstrap/assets/img/photo-3.jpg"></a>
                <div class="media-body">
                  <h4 class="media-heading">Nested media heading</h4>
      ...
      <li class="media">
        <a class="pull-right" href="#"><img class="media-object img-rounded" src="themes/bootstrap/assets/img/photo-4.jpg"></a>
        <div class="media-body">
          <h4 class="media-heading">Media heading</h4>
...
<div class="row">
  <div class="col-md-12">
    <div class="footer">
      <div class="container">
        <div class="clearfix">
          <div class="footer-logo"><a href="#"><img src="themes/bootstrap/assets/img/footer-logo.png" />Bootflat</a></div>
          <dl class="footer-nav">
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="example-typography">
      ...
      <img src="themes/bootstrap/assets/img/slider1.jpg" alt="exaple-image" class="themes/bootstrap/assets/img-rounded img-responsive">
      <p class="themes/bootstrap/assets/img-comment"><strong>Note:</strong> gravida at eget metus. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</p>
    </div>
    <div class="example-typography">
